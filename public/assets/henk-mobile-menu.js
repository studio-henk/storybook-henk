...
export const mobileMenu = {
    ...
    get header() {
        return document.querySelector(this.headerAttr);
    },
    get headerInner() {
        return document.querySelector("header.henk-header > .henk-header__inner");
    },
    get hamburgerButtonSelector() {
        return document.querySelector(this.openButtonAttr);
    },
    get closeButtonSelector() {
        return document.querySelector(this.closeButtonAttr);
    },
    removeTrap: null,
...
<span class="visually-hidden">Menu</span>
    ...
    toggleMenu() {
        ...
        if (mobileMenu.header.dataset.state === "open") {
            ...
            if (!mobileMenu.header)
                return;
            if (!mobileMenu.hamburgerButtonSelector)
                return;
            if (!mobileMenu.closeButtonSelector)
                return;
