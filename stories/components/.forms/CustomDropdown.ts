...
export const createCustomDropdown = ({
    ...
    options.forEach(option => {
        ...
        item.addEventListener('click', () => {
            ...
            const prevSelected = dropdownList.querySelector('.dropdown-item.selected');
            if (prevSelected) {
    ...
    input.addEventListener('keydown', (event) => {
        ...
        let selectedIndex = Array.from(visibleItems).findIndex(item => item.classList.contains('selected'));
