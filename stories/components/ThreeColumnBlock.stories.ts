...
import { createThreeColumnBlock, ThreeColumnBlockProps } from './ThreeColumnBlock';
...
const meta: Meta = {
    ...
    tags: ['autodocs'],
    render: (args) => createThreeColumnBlock(args as ThreeColumnBlockProps),
    parameters: {
        docs: {
            description: {
                component:
    ...
    args: {
        ...
        columns: [
            {
                imageUrl: 'https://www.studio-henk.nl/Images/samples-landingpage/4-steps-block/1020940/image-thumb__1020940__blogsliderBrickImageThumb/samplesservice2@2x.avif',
            ...
            {
                imageUrl: 'https://www.studio-henk.nl/Images/home/new-home/services/636298/image-thumb__636298__blogsliderBrickImageThumb/studio-henk-interior-advice-2@2x.avif',
            ...
            {
                imageUrl: 'https://www.studio-henk.nl/_default_upload_bucket/1021643/image-thumb__1021643__blogsliderBrickImageThumb/Our%20Stores@2x.avif',
...
export const MinimalCentered: StoryObj = {
    args: {
