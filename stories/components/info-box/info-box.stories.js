...
VariantInfo.args = {
  variant: 'info',
  title: 'Did you know?',
  content: '<p>Our tables come in different sizes. You can <a href="#">choose the size</a> that best fits your needs.</p>',
  buttonConfig: null,
  // iconHTML: InfoDefault(),
  iconHTML: InfoOpenDefault(),
};
...
VariantWarning.args = {
  variant: 'warning',
  title: 'Warning!',
  content: '<p>Step away from the computer! You have <a href="#">10 seconds</a> to comply.</p>',
  buttonConfig: null,
...
VariantDanger.args = {
  variant: 'danger',
  title: 'Be careful!',
  content: '<p>This is a dangerous box. <a href="#">Don\'t click the button</a>! Clicking the button will cause the box to disappear.</p>',
  buttonConfig: null,
...
LocationExample.args = {
  ...
  content: '<p><a href="#">Bezoek ons</a> of maak een afspraak in Amsterdam, Antwerpen, Rotterdam of Utrecht.</p>',
  buttonConfig: {
    buttonElement: 'a',
