...
import { createHeadingElement, type HeadingProps } from '@components/Headings';
...
export const Heading1Lineheight: Story = {
    args: {
        tag: 'h1',
        text:
            'Heading 1 with much much much much much much more text to see how it flows over multiple lines',
    },
};
