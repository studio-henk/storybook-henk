...
<div class="${classes.join(" ")}">
      ...
      ${
        variant === "default"
          ...
          `
          : `
            <div class="henk-card__content ${contentDir ? `henk-card__content--${contentDir}` : ""} ">
              <p class="henk-card__title truncate">${title}</p>
              ...
              <a
                href="${href}"
                class="henk-button henk-card__button ${buttonVariant ? `henk-button--${buttonVariant}` : ""}
                ${buttonSize ? `henk-button--${buttonSize}` : ""}">${buttonLabel}</a>`
                  : ""
              }
            </div>
          `
